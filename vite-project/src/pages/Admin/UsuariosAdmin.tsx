...
export default function UsuariosAdmin() {
      ...
      setUsuarios((prev) =>
        prev.map((u) =>
          u.id === usuarioEditando.id
            ? { ...u, nombre_completo: formNombre, telefono: formTelefono, rol: formRol, estado: formEstado }
            : u
        )
      );
  ...
  const guardarNuevoUsuario = async () => {
    ...
    if (nuevoRol === 'doctor') {
      alert('Los doctores deben registrarse desde el módulo Doctores');
      return;
    }
  ...
  return (
    <AdminLayout titulo="Usuarios" subtitulo="Gestión de cuentas y control de acceso del sistema">
      <div style={styles.cardsGrid}>
        <div style={styles.card}>
          <p style={styles.cardTitle}>Total usuarios</p>
          <h3 style={styles.cardValue}>{resumen.total}</h3>
          <p style={styles.cardSubtitle}>Usuarios registrados</p>
        </div>
        <div style={styles.card}>
          <p style={styles.cardTitle}>Administradores</p>
          <h3 style={styles.cardValue}>{resumen.admins}</h3>
          <p style={styles.cardSubtitle}>Cuentas administrativas</p>
        </div>
        <div style={styles.card}>
          <p style={styles.cardTitle}>Doctores</p>
          <h3 style={styles.cardValue}>{resumen.doctores}</h3>
          <p style={styles.cardSubtitle}>Usuarios con rol doctor</p>
        </div>
        <div style={styles.card}>
          <p style={styles.cardTitle}>Pacientes</p>
          <h3 style={styles.cardValue}>{resumen.pacientes}</h3>
          <p style={styles.cardSubtitle}>Usuarios con rol paciente</p>
        </div>
      </div>
              ...
              <tbody>
                {usuariosFiltrados.map((usuario) => (
                  <tr key={usuario.id}>
                    ...
                    <td style={styles.td}>
                      <span style={getRolStyle(usuario.rol)}>{usuario.rol}</span>
                    </td>
                    <td style={styles.td}>
                      <span style={usuario.estado === 'activo' ? styles.badgeActive : styles.badgeInactive}>
                        {usuario.estado}
                      </span>
                    </td>
                    <td style={styles.td}>
                    ...
                    <td style={styles.td}>
                      <div style={styles.actionsRow}>
                        ...
                        <button
                          style={usuario.estado === 'activo' ? styles.btnDelete : styles.btnEdit}
        ...
        <div style={styles.modalOverlay}>
          <div style={styles.modal}>
            ...
            <div style={styles.formGroup}>
              ...
              <input type="text" value={formNombre} onChange={(e) => setFormNombre(e.target.value)} style={styles.input} />
            </div>
            <div style={styles.formGroup}>
              <label style={styles.label}>Teléfono</label>
              <input type="text" value={formTelefono} onChange={(e) => setFormTelefono(e.target.value)} style={styles.input} />
            </div>
            <div style={styles.formGroup}>
      ...
      {mostrarModalNuevo && (
        <div style={styles.modalOverlay}>
          <div style={styles.modal}>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>Nombre completo</label>
              <input type="text" value={nuevoNombre} onChange={(e) => setNuevoNombre(e.target.value)} style={styles.input} />
            </div>
            <div style={styles.formGroup}>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>Teléfono</label>
              <input type="text" value={nuevoTelefono} onChange={(e) => setNuevoTelefono(e.target.value)} style={styles.input} />
            </div>
            <div style={styles.formGroup}>
              <label style={styles.label}>Contraseña</label>
              <input type="password" value={nuevaContrasena} onChange={(e) => setNuevaContrasena(e.target.value)} style={styles.input} />
            </div>
            <div style={styles.formGroup}>
              <label style={styles.label}>Rol</label>
            ...
            <div style={styles.modalActions}>
              ...
              <button style={styles.btnPrimary} onClick={guardarNuevoUsuario} disabled={guardandoNuevo}>
