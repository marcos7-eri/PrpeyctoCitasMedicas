...
export default function NotificacionesDoctor() {
  ...
  return (
    <DoctorLayout titulo="Notificaciones" subtitulo="Avisos y mensajes del sistema">
            ...
            <table style={styles.table}>
              ...
              <tbody>
                {notificaciones.map((notif) => (
                  <tr
                    key={notif.id}
                    style={!notif.leido ? { background: 'rgba(49,151,149,0.05)' } : {}}
                  >
                    <td style={styles.td}>
                    ...
                    <td style={styles.td}>
                      {notif.mensaje.length > 60
                        ? notif.mensaje.substring(0, 60) + '...'
                        : notif.mensaje}
                    </td>

                    <td style={styles.td}>
                      <span style={getTipoBadge(notif.tipo)}>{notif.tipo}</span>
                    </td>

                    <td style={styles.td}>
                      <span style={notif.leido ? styles.badgeConfirmado : styles.badgePendiente}>
                    ...
                    <td style={styles.td}>
                      <div style={styles.actionsRow}>
                        <button
                          ...
                          onClick={() => marcarComoLeida(notif.id, notif.leido)}
                        >
                          {notif.leido ? 'No leída' : 'Leída'}
                        </button>
