...
export default function PerfilDoctor() {
  ...
  const guardarPerfil = async () => {
    ...
    try {
      ...
      const { error } = await supabase.from('perfiles').update({ nombre_completo: formNombre.trim(), correo: formCorreo.trim(), telefono: formTelefono.trim() || null, foto_url: fotoUrlFinal }).eq('id', perfil.id);
    ...
    } catch { alert('Ocurrió un error al guardar'); } finally { setGuardando(false); }
  };
