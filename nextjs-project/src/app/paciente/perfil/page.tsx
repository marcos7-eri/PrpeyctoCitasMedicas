  ...
  return (
    <>
      <div style={styles.cardsGrid}>
        <div style={styles.card}><p style={styles.cardTitle}>Rol</p><h3 style={styles.cardValue}>Paciente</h3><p style={styles.cardSubtitle}>Tipo de usuario</p></div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '24px' }}>
            {fotoPreview ? (
              ...
              <div style={{ width: '180px', height: '180px', borderRadius: '50%', background: 'linear-gradient(135deg, #319795 0%, #1a5a58 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '48px', fontWeight: 'bold', color: '#FFFFFF' }}>
                {perfil.nombre_completo?.charAt(0).toUpperCase() || 'P'}
              </div>
            )}
          </div>
